...
2.GUI 
	...
	If any user input a bid value that is greater than the current bid value corresponding bid value will change in th GUI.
	GUI can used to track all the changes done to the stock item by entering the symbol that is to be serached and click 'Enter' button.
...
3. 	Then the client can enter his/her bid value. If it is above the current value the bid is accepted or else he/she has to try again.
